# Trabajo Práctico: Sistema de Gestión de Gimnasio 🏋️‍♂️

## 👥 Integrantes - Grupo [Número de grupo]
* **Miño, Nicolas** - [30999/39776908]
* **Apellido, Nombre** - [23714/33353184]
...
1. **Registrar Socio:** Permite ingresar un nuevo cliente validando que el DNI sea numérico y no esté duplicado.
2. **Control de Cuotas:** Permite verificar si un socio está al día o registra deuda.
...
1. Clonar el repositorio o descargar el archivo `ProyectoGymPass.py`.
2. Abrir la terminal en la carpeta donde está el archivo.
3. Ejecutar el siguiente comando: 
   ```bash 
   python ProyectoGymPass.py
---
